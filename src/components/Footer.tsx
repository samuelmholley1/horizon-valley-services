        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:707-972-4525" className="hover:text-horizon-white transition-colors flex items-center gap-2">
              ...
              <li>
                <a href="mailto:info@horizonvalleycleaning.com" className="hover:text-horizon-white transition-colors flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  info@horizonvalleycleaning.com
                </a>
              </li>
