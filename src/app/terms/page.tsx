  ...
  return (
    <main className="min-h-screen bg-horizon-black">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-5xl font-bold text-horizon-white mb-4">Terms of Service</h1>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Agreement to Terms</h2>
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Services Provided</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Scheduling and Cancellations</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Payment Terms</h2>
            <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Property Access and Preparation</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              You agree to:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h3 className="text-2xl font-bold text-horizon-white mb-4">5. Liability & Insurance</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Satisfaction Guarantee</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Limitation of Liability</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800 mb-8">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Changes to Terms</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-800">
            <h2 className="text-2xl font-bold text-horizon-white mb-4">Contact Information</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p><strong>Phone:</strong> <a href="tel:7079724525" className="text-blue-400 hover:underline">(707) 972-4525</a></p>
