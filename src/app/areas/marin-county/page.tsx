        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <a 
              ...
              className="bg-horizon-white hover:bg-gray-100 text-teal-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors text-center"
            >
              📞 Call (559) 960-2749
            </a>
          </div>
      ...
      <section className="py-16 px-4 bg-horizon-black text-horizon-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12">
            <a 
              href="tel:559-960-2749"
              className="inline-block bg-teal-500 hover:bg-teal-600 text-white px-10 py-4 rounded-lg font-bold text-lg transition-colors"
            >
