        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <a 
              ...
              className="bg-horizon-white hover:bg-gray-100 text-blue-900 px-8 py-4 rounded-lg font-semibold text-lg transition-colors text-center"
            >
              📞 Call (559) 960-2749
            </a>
          </div>
      ...
      <section className="py-16 px-4 bg-horizon-black text-horizon-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12">
            <a 
              href="tel:559-960-2749"
              className="inline-block bg-blue-500 hover:bg-blue-600 text-white px-10 py-4 rounded-lg font-bold text-lg transition-colors"
            >
              Call Now for SF County Service: (559) 960-2749
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-horizon-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-horizon-slate">
                We offer same-week service for most San Francisco County locations. Call us at (559) 960-2749 and we&apos;ll check our schedule for your area.
              </p>
            </div>
